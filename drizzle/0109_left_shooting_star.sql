ALTER TABLE "message_request" ADD COLUMN "observed_input_tokens" bigint;--> statement-breakpoint
ALTER TABLE "message_request" ADD COLUMN "cache_write_tokens_reported" bigint;--> statement-breakpoint
ALTER TABLE "message_request" ADD COLUMN "cache_write_accounting" varchar(64);--> statement-breakpoint
ALTER TABLE "usage_ledger" ADD COLUMN "cost_breakdown" jsonb;--> statement-breakpoint
ALTER TABLE "usage_ledger" ADD COLUMN "observed_input_tokens" bigint;--> statement-breakpoint
ALTER TABLE "usage_ledger" ADD COLUMN "cache_write_tokens_reported" bigint;--> statement-breakpoint
ALTER TABLE "usage_ledger" ADD COLUMN "cache_write_accounting" varchar(64);--> statement-breakpoint
ALTER TABLE "usage_ledger" ADD COLUMN "special_settings" jsonb;--> statement-breakpoint
-- Keep the durable ledger trigger aligned with src/lib/ledger-backfill/trigger.sql.
-- Existing rows are not updated; provenance remains NULL until a request receives a new write.
