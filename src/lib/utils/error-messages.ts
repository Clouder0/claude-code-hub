...
export const SERVER_ERRORS = {
  ...
  GATEWAY_CYBER_REQUEST_RESTRICTED: "GATEWAY_CYBER_REQUEST_RESTRICTED",
  GATEWAY_CYBER_SESSION_RESTRICTED: "GATEWAY_CYBER_SESSION_RESTRICTED",
  GATEWAY_CYBER_CLIENT_RESTRICTED: "GATEWAY_CYBER_CLIENT_RESTRICTED",
  GATEWAY_CYBER_PRINCIPAL_RESTRICTED: "GATEWAY_CYBER_PRINCIPAL_RESTRICTED",
  CYBER_CHECK_UNAVAILABLE: "CYBER_CHECK_UNAVAILABLE",
  CYBER_CHECK_CAPACITY: "CYBER_CHECK_CAPACITY",
  CYBER_CHECK_NOT_CONFIGURED: "CYBER_CHECK_NOT_CONFIGURED",
  CYBER_PRINCIPAL_RESET_REQUIRED: "CYBER_PRINCIPAL_RESET_REQUIRED",
  NOT_FOUND: "NOT_FOUND",
